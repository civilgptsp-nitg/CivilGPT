# app.py — CivilGPT v1.6.3 (full drop-in: polish + robust CSV handling + professional PDF + collapsible downloads)
...
st.markdown("---")
st.caption("CivilGPT v1.6.3 | Refinement update — professional PDF, collapsible downloads, graceful CSV handling, no deletions")
